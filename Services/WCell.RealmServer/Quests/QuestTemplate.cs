...
namespace WCell.RealmServer.Quests
{
	...
	public partial class QuestTemplate : IDataHolder
	{
		...
		*/
        ...
        /// </summary>
        [Persistent(QuestConstants.MaxObjectInteractions)]
        public Asda2ItemStackDescription[] CollectableSourceItems = new Asda2ItemStackDescription[QuestConstants.MaxObjectInteractions];
		...
		/// </summary>
		[Persistent(QuestConstants.MaxObjectInteractions)]
		public Asda2ItemStackDescription[] CollectableItems;
		...
		/// </summary>
		[NotPersistent]
		public List<Asda2ItemStackDescription> ProvidedItems = new List<Asda2ItemStackDescription>(1);
...
#pragma warning restore
		...
		/// <returns></returns>
		public QuestStatus GetEndStatus(QuestHolderInfo questHolderInfo, Character chr)
		{
			var quest = chr.QuestLog.GetActiveQuest(Id);
			if (quest == null)
			{
		...
		public void FinalizeDataHolder()
		{
			...
			var colItems = new List<Asda2ItemStackDescription>(4);
            ...
            {
                if (CollectableSourceItems[i].ItemId != Asda2ItemId.None && CollectableSourceItems[i].Amount == 0)
                {
