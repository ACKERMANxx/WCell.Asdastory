...
namespace WCell.RealmServer.Chat
{
	...
	public class ChatChannel : IChatTarget
	{
		...
		public void SendMessage(IRealmClient client, IChatter sender, string message)
		{
		    ChannelMember mi;
            ...
            var chr = World.GetCharacter(sender.Name, true);
            ChannelHandler.SendPacketToChannel(this, ChatMgr.CreateNormalChatMessagePacket(sender.Name,message,Locale.En,chr));
        ...
        {
            Staff.SendMessage(sender, message);
        }
