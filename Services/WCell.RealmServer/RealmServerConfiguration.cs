...
namespace WCell.RealmServer
{
	...
	public class RealmServerConfiguration : WCellConfig<RealmServerConfiguration>
	{
		...
		private static string _dbConnectionString = @"Server=127.0.0.1;Port=3306;Database=asdastory;CharSet=utf8;Uid=root;Pwd=root;";
		...
		/// </summary>
	    [NotVariable]
		public static int MaxCharacterLevel = 70;
	}
}