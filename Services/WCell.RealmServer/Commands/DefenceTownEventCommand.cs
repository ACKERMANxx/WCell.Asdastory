    ...
    public class DefenceTownEventCommand : RealmServerCommand
    {
        ...
        public class StartCommand : SubCommand
        {
            ...
            public override void Process(CmdTrigger<RealmServerCmdArgs> trigger)
            {
                ...
                Asda2EventMgr.StartDeffenceTownEvent(map, minLevel, maxLevel, amountMod, healthMod, otherStatsMod, speedMod, difficulty);
                trigger.Reply("Ok, defence town event started. Town is {0}, dificulty is {1}. [{2}-{3}]Level", map.Name, difficulty, minLevel, maxLevel);
            }
        }
