...
namespace WCell.RealmServer.Commands
{
	public class BattlegroundCommand : RealmServerCommand
	{
        ...
        public class Start : SubCommand
        {
            ...
            {
                var bgNum = trigger.Text.NextInt(0);
                var bgType = trigger.Text.NextInt(0);
                var bg = Asda2BattlegroundMgr.AllBattleGrounds[(Asda2BattlegroundTown) bgNum][0];
                bg.WarType = bgType == 0 ? Asda2BattlegroundType.Occupation : Asda2BattlegroundType.Deathmatch;
                bg.Start();
        ...
        public class Stop : SubCommand
        {
            ...
            {
                var bgNum = trigger.Text.NextInt(0);
                Asda2BattlegroundMgr.AllBattleGrounds[(Asda2BattlegroundTown)bgNum][0].Stop();
        ...
        public class AddPoints : SubCommand
        {
            ...
            public override void Process(CmdTrigger<RealmServerCmdArgs> trigger)
            {
                ...
                chr.Asda2HonorPoints += points;
                trigger.Reply(chr.Name + " get points. And now have "+chr.Asda2HonorPoints);
            }
        }
        public class Join : SubCommand
        {
            ...
            public override void Process(CmdTrigger<RealmServerCmdArgs> trigger)
            {
                ...
                Asda2BattlegroundMgr.AllBattleGrounds[(Asda2BattlegroundTown)bgNum][0].Join(chr);
                trigger.Reply(chr.Name +" joined BG.");
            }
        }
        public class Leave : SubCommand
        {
            ...
            public override void Process(CmdTrigger<RealmServerCmdArgs> trigger)
            {
                ...
                chr.CurrentBattleGround.Leave(chr);
                trigger.Reply(chr.Name + " leaved BG.");
            }
        }
/*
		#region Cfg
