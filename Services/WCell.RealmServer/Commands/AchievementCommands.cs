    ...
    public class Asda2TitlesCommands : RealmServerCommand
    {
        ...
        public class AddTitleCommand : SubCommand
        {
            ...
            public override void Process(CmdTrigger<RealmServerCmdArgs> trigger)
            {
                ...
                if (trigger.Text.String.Contains("all"))
                {
                    ...
                    {
                        (trigger.Args.Target as Character).AsdaStoryGetTitle((Asda2TitleId)i);
                    }
                }
                var achievementId = trigger.Text.NextUInt(0u);
                ...
                (trigger.Args.Target as Character).AsdaStoryGetTitle((Asda2TitleId) achievementId);
                trigger.Reply("Done.");
            }
        ...
        public class DiscoverTitleCommand : SubCommand
        {
            ...
            public override void Process(CmdTrigger<RealmServerCmdArgs> trigger)
            {
                ...
                (trigger.Args.Target as Character).AsdaStoryDiscoverTitle((Asda2TitleId)achievementId);
                trigger.Reply("Done.");
            }
