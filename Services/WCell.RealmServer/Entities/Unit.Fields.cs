...
namespace WCell.RealmServer.Entities
{
	public partial class Unit
	{
        ...
        protected Database.CharacterRecord m_Record;
	    ...
	    public bool IsSitting
        {
            ...
            set
            {
                ...
                if (Map != null && chr != null)
                {
                    ...
                    Map.CallDelayed(100,
                                    () =>
                                    Asda2CharacterHandler.SendEmoteResponse(chr, (short) (value ? 108 : 109), 0, 0, 0));
                }
            }
        }
		...
		{
			var ip = (PowerRegenPerTickActual * delayMillis) / RegenerationFormulas.RegenTickDelayMillis;	// rounding
		   _tempPower += ip;
		    _timeFromLastMpUpdate += delayMillis;
            if(_timeFromLastMpUpdate>DefaultHealthAndPowerUpdateTime)
            {
                _timeFromLastMpUpdate = 0;
                if (_tempPower>1)
                {
                    var d = (int) _tempPower;
                    _tempPower -= d;
                    if (Power < MaxPower)
                    {
                        Power += d;
	    ...
	    private float _asda2DropChance = 1;
        ...
        //TODO ASDA realize LUCK
        public int Asda2BaseLuck { get; set; }
        public int Asda2BaseStrength 
		{ get;set;
			}
	    ...
	    private float _asda2GoldAmountBoost = 1;
	    private float _asda2ExpAmountBoost = 1;
	    ...
	    {
	        get {
	            return _asda2ExpAmountBoost;
	        }
	        set {
	            _asda2ExpAmountBoost = value;
	        }
	    }
