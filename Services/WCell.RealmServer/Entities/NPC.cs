...
namespace WCell.RealmServer.Entities
{
    ...
    public partial class NPC : Unit, IQuestHolder
    {
                ...
                m_Map.CallDelayed(LastDamageDelay, () =>
                                                       {
                                                           ...
                                                           /*var quests = QuestRecord.GetQuestRecordForCharacter(chr.EntityId.Low);
                                                           foreach (var quest in quests)
                                                           {
                                                               Console.WriteLine(Template.Id + " " + quest.Monster1);
                                                               if (Template.Id == quest.Monster1 || Template.Id -1 == quest.Monster1)
                                                               {

                                                                   //quest.Item1Amount++;
                                                                   Asda2Item neww = new Asda2Item();
                                                                   //chr.Asda2Inventory.TryAdd(quest.Item1Id, 1, true,ref neww, Asda2_Items.Asda2InventoryType.Quests);
                                                                   quest.Item1Amount++;
                                                                   quest.SaveAndFlush();
                                                                   using (var packet = new RealmPacketOut((RealmServerOpCode)5052))
                                                                   {
                                                                       packet.WriteInt32(quest == null ? -1 : quest.QuestTemplateId);//{questId}default value : -1 Len : 4
                                                                       packet.WriteByte(0);//value name : unk1 default value : 0Len : 1
                                                                       packet.WriteInt16(quest == null ? -1 : quest.Slot);//{questSlot}default value : -1 Len : 2
                                                                       packet.WriteInt32(quest == null ? -1 : quest.Item1Id); // Updated item
                                                                       packet.WriteInt16(1); // slot maybe? 
                                                                       packet.WriteSkip(StrToByteArray("FFFFFFFF0000000000"));
                                                                       packet.WriteInt32(quest == null ? -1 : quest.QuestFileId);
                                                                       packet.WriteByte(4);
                                                                       packet.WriteInt16(1);
                                                                       //packet.WriteByte(quest == null ? 0 : quest.QuestStage);//{questStage}default value : 0 Len : 1 2 - in progress 1 - completed
                                                                       packet.WriteInt16(quest == null ? -1 : quest.QuestTemplateId);//{oneMoreQuestId}default value : -1 Len : 2
                                                                       packet.WriteInt16(quest == null ? 0 : quest.CompleteStatus);//{IsCompleted}default value : 2 Len : 2  0 or 1
                                                                       packet.WriteInt16(0);
                                                                       packet.WriteInt32(quest == null ? -1 : quest.Item1Id);//{questItemId}default value : -1 Len : 4
                                                                       packet.WriteInt16(quest == null ? 0 : quest.Item1Amount);//{questItemAmount}default value : 0 Len : 2
                                                                       packet.WriteInt32(quest == null ? -1 : quest.Item2Id);//{questItemId}default value : -1 Len : 4
                                                                       packet.WriteInt16(quest == null ? 0 : quest.Item2Amount);//{questItemAmount}default value : 0 Len : 2
                                                                       packet.WriteInt32(quest == null ? -1 : quest.Item3Id);//{questItemId}default value : -1 Len : 4
                                                                       packet.WriteInt16(quest == null ? 0 : quest.Item3Amount);//{questItemAmount}default value : 0 Len : 2
                                                                       packet.WriteInt32(quest == null ? -1 : quest.Item4Id);//{questItemId}default value : -1 Len : 4
                                                                       packet.WriteInt16(quest == null ? 0 : quest.Item4Amount);//{questItemAmount}default value : 0 Len : 2
                                                                       packet.WriteInt32(quest == null ? -1 : quest.Item5Id);//{questItemId}default value : -1 Len : 4
                                                                       packet.WriteInt16(quest == null ? 0 : quest.Item5Amount);//{questItemAmount}default value : 0 Len : 2
                                                                   ...
                                                                   Asda2QuestHandler.SendQuestsListResponse(chr.Client);
                                                               }
                                                               if (quest.Monster2 == this.DisplayId)
                                                                   quest.Item2Amount++;
                                                               if (quest.Monster3 == this.DisplayId)
                                                                   quest.Item3Amount++;
                                                               if (quest.Monster4 == this.DisplayId)
                                                                   quest.Item4Amount++;
                                                               if (quest.Monster5 == this.DisplayId)
                                                                   quest.Item5Amount++;
                                                           }
                                                           if (chr.IsInGroup)
                                                           {
                                                               foreach (var item in chr.Group)
                                                               {
                                                                   item.Character.countq++;
                                                                   if (item.Character.countq <= 5)
                                                                   {
                                                                       var packet = new RealmPacketOut((RealmServerOpCode)5052); //6561
                                                                       packet.WriteSkip(StrToByteArray("5A000000000100795200000100FFFFFFFF00000000002B080000040000" + (item.Character.countq != 5 ? "02" : "01") + "5A00" +  "0000" + "000079520000"));
                                                                       packet.WriteInt16(item.Character.countq);
                                                                       packet.WriteSkip(StrToByteArray(""));
                                                                       item.Character.Send(packet, true);
                                                                   }
                                                               }
                                                           }
                                                           else
                                                           {
                                                               ...
                                                               {
                                                                   var packet = new RealmPacketOut((RealmServerOpCode)5052); //6561
                                                                   packet.WriteSkip(StrToByteArray("5A000000000100795200000100FFFFFFFF00000000002B080000040000" + (chr.countq != 5 ? "02" : "01") + "5A00" + "0000" + "000079520000"));
                                                                   packet.WriteInt16(chr.countq);
                                                                   packet.WriteSkip(StrToByteArray(""));
                                                           ...
                                                           EnterFinalState();
                                                           if (chr.QuestRecords.Length > 0)
                                                           {
                                                               foreach (QuestRecord record in chr.QuestRecords)
                                                               {
                                                                   if (record.Monster1 == this.EntityId.Entry)
                                                                       Asda2Quests.Asda2QuestMgr.UpdateQuest(chr.Client, record, 1);
                                                                   if (record.Monster2 == this.EntityId.Entry)
                                                                       Asda2Quests.Asda2QuestMgr.UpdateQuest(chr.Client, record, 2);
                                                                   if (record.Monster3 == this.EntityId.Entry)
                                                                       Asda2Quests.Asda2QuestMgr.UpdateQuest(chr.Client, record, 3);
                                                                   if (record.Monster4 == this.EntityId.Entry)
                                                                       Asda2Quests.Asda2QuestMgr.UpdateQuest(chr.Client, record, 4);
                                                                   if (record.Monster5 == this.EntityId.Entry)
                                                                       Asda2Quests.Asda2QuestMgr.UpdateQuest(chr.Client, record, 5);
                                                               }
                                                           }
                                                       });
        ...
        public void CheckQuestsForChar(Character chr, QuestRecord Quest, int MonsterId)
        {
            if (Quest.Monster1 == this.DisplayId)
            {
                Quest.Item1Amount++;
            }
        }
        ...
        private Character CalcLooter()
        {
            try
            {
                ...
                if (Entry.Rank >= CreatureRank.Boss)
                {
                    SendMessageToArea(string.Format("Top {0} damagers are : ", CharacterFormulas.MaxDamagersDetailCount), Color.MediumVioletRed);
                    var i = 1;
