...
namespace WCell.RealmServer.Entities
{
    ...
    public partial class Character
    {
        ...
        protected internal Asda2QuestRecord m_questRecord;
        ...
        public int ApplyFunctionItemBuff(int itemId, bool isLongTimeBuff = false)
        {
            ...
            if (isLongTimeBuff)
            {
                ...
                if (nb.Template.Category == Asda2ItemCategory.PremiumPotions)
                    switch (nb.Template.ValueOnUse)
                    {
                        case 1:
                            nb.EndsDate = DateTime.Now.AddDays(30);
                            break;
                        case 2:
                            nb.EndsDate = DateTime.Now.AddDays(7);
                            break;
                        default:
                            nb.EndsDate = DateTime.Now.AddDays(7);
                            break;
        ...
        void ProcessFunctionalItemEffect(FunctionItemBuff item, bool isPositive)
        {
            ...
            switch (item.Template.Category)
            {
                ...
                case Asda2ItemCategory.PremiumPotions:
                    ...
                    this.ChangeModifier(StatModifierFloat.Damage, (isPositive ? 1f : -1f) * 10f / 100f);
                    this.ChangeModifier(StatModifierFloat.MagicDamage, (isPositive ? 1f : -1f) * 10f / 100f);
                ...
                case Asda2ItemCategory.DoublePetExpirience:
                    this.ChangeModifier(StatModifierFloat.Asda2PetExp, value / 100);
                    break;
            }
            if (!isPositive)
        ...
        public int SoulStoneExperience
        {
            get;
            set;
        }
        ...
        {
            Account.AccountData.Points = Account.AccountData.Points + amount;
            Account.AccountData.Update();
        }

        /// <summary>
        /// Subtracts the given amount of Points. Returns false if its more than this Character has.
        /// </summary>
        public bool SubtractPoints(int amount)
        {
            if (amount > Account.AccountData.Points)
            {
                return false;
            }
        ...
        public Asda2QuestRecord Asda2QuestRecord
        {
            get { return m_questRecord; }
        }
        ...
        public byte ProfessionLevel
        {
            ...
            set
            {
                m_record.ProfessionLevel = value; if (IsInGuild)
                    Asda2GuildHandler.SendGuildNotificationResponse(Guild, GuildNotificationType.Silence, GuildMember);
            }
        }
        ...
        //TODO Calc RATING
        public int PlaceInRaiting { get; set; }
        ...
        public int Quest1
        {
            get { return Record.Quest1; }
            set { Record.Quest1 = value; }
        }

        public int Quest2
        {
            get { return Record.Quest2; }
            set { Record.Quest2 = value; }
        }

        public int Quest3
        {
            get { return Record.Quest3; }
            set { Record.Quest3 = value; }
        }

        public int Quest4
        {
            get { return Record.Quest4; }
            set { Record.Quest4 = value; }
        }

        public int Quest5
        {
            get { return Record.Quest5; }
            set { Record.Quest5 = value; }
        }

        public int Quest6
        {
            get { return Record.Quest6; }
            set { Record.Quest6 = value; }
        }

        public int Quest7
        {
            get { return Record.Quest7; }
            set { Record.Quest7 = value; }
        }

        public int Quest8
        {
            get { return Record.Quest8; }
            set { Record.Quest8 = value; }
        }

        public int Quest9
        {
            get { return Record.Quest9; }
            set { Record.Quest9 = value; }
        }

        public int Quest10
        {
            get { return Record.Quest10; }
            set { Record.Quest10 = value; }
        }

        public int Quest11
        {
            get { return Record.Quest11; }
            set { Record.Quest11 = value; }
        }

        public int Quest12
        {
            get { return Record.Quest12; }
            set { Record.Quest12 = value; }
        }
        public int FirstTree
        {
            get { return Record.FirstTree; }
            set { Record.FirstTree = value; }
        }

        public int SecondTree
        {
            get { return Record.SecondTree; }
            set { Record.SecondTree = value; }
        }

        public int ThirdTree
        {
            get { return Record.ThirdTree; }
            set { Record.ThirdTree = value; }
        }

        public int FourthTree
        {
            get { return Record.FourthTree; }
            set { Record.FourthTree = value; }
        }
        public bool CheckQuest(int templateId)
        {
            var Rec = QuestRecord.GetQuestRecordForCharacter(this.EntityId.Low);
            if (Rec.Contains(qi => qi.QuestTemplateId == templateId))
            {
                return true;
            }
            return false;
        ...
        public QuestRecord[] QuestRecords
        {
            get
            {
                var qr = QuestRecord.GetQuestRecordForCharacter(this.EntityId.Low);
                return qr;
            }
            set
            {
        ...
        public void SetQuest1(int id)
        {
            Quest1 = id;
        }
        public void SetQuest2(int id)
        {
            Quest2 = id;
        }
        public void SetQuest3(int id)
        {
            Quest3 = id;
        }
        public void SetQuest4(int id)
        {
            Quest4 = id;
        }
        public void SetQuest5(int id)
        {
            Quest5 = id;
        }
        public void SetQuest6(int id)
        {
            Quest6 = id;
        }
        public void SetQuest7(int id)
        {
            Quest7 = id;
        }
        public void SetQuest8(int id)
        {
            Quest8 = id;
        }
        public void SetQuest9(int id)
        {
            Quest9 = id;
        }
        public void SetQuest10(int id)
        {
            Quest10 = id;
        }
        public void SetQuest11(int id)
        {
            Quest11 = id;
        }
        public void SetQuest12(int id)
        {
            Quest12 = id;
        }

        public void UnsetQuest1(int id)
        {
            Quest1 = id;
        }
        public void UnsetQuest2(int id)
        {
            Quest2 = id;
        }
        public void UnsetQuest3(int id)
        {
            Quest3 = id;
        }
        public void UnsetQuest4(int id)
        {
            Quest4 = id;
        }
        public void UnsetQuest5(int id)
        {
            Quest5 = id;
        }
        public void UnsetQuest6(int id)
        {
            Quest6 = id;
        }
        public void UnsetQuest7(int id)
        {
            Quest7 = id;
        }
        public void UnsetQuest8(int id)
        {
            Quest8 = id;
        }
        public void UnsetQuest9(int id)
        {
            Quest9 = id;
        }
        public void UnsetQuest10(int id)
        {
            Quest10 = id;
        }
        public void UnsetQuest11(int id)
        {
            Quest11 = id;
        }
        public void UnsetQuest12(int id)
        {
            Quest12 = id;
        }
        ...
        {
            get { return (byte)GuildRank; }
            set { GuildRank = (uint)value; }
        }
        ...
        public DateTime SoulmateSafeHandsEndTime { get; set; }
        ...
        private void ApplyStat(Asda2PetStatType type, int value)
        {
            switch (type)
            {
                ...
                case Asda2PetStatType.MagicDeffence:
                    Owner.ApplyStatMod(ItemModType.Asda2MagicDefence, (int)(value * CharacterFormulas.PetMagicDeffenceMultiplier));
                    break;
