...
namespace WCell.RealmServer.Handlers
{
        ...
        private static readonly byte[] Unk13 = new byte[40]
     {
      ...
      byte.MaxValue
        ...
        public static void SendCharacterVisibleNowResponse(IRealmClient client, Character visibleChr)
        {
            ...
            {
                if (client.ActiveCharacter.Map != null)
                    client.ActiveCharacter.Map.CallDelayed(200, () => Asda2MovmentHandler.SendStartMoveCommonToAreaResponse(visibleChr, true, true));
            }
        }
        ...
        public static RealmPacketOut CreateCharacterPlaceInRaitingPacket(Character chr)
        {
            ...
            packet.WriteInt32(chr.Asda2Rank); //{placeInRaiting}default value : 4455 Len : 4
        ...
        public static void SendCharacterFriendShipResponse(IRealmClient client, Character chr)
        {
            ...
            using (var packet = new RealmPacketOut(RealmServerOpCode.CharacterFriendShip))//6152
            {
                ...
                packet.WriteInt32(chr.SoulmateCharacter.AccId);//{friendAccId}default value : 321713 Len : 4
                packet.WriteInt16(1);//value name : unk2 default value : 0Len : 2
                client.Send(packet);
            }*/

            // TODO: idk to be ficed
        }
            ...
            {
                {
                    ...
                    packet.WriteInt32(npc.UniqWorldEntityId); //{uniqIdOnMap}default value : 239 Len : 4
        ...
        public static void SendMonstrVisibleNowResponse(IRealmClient client, NPC visibleNpc)
        {
            using (var packet = new RealmPacketOut(RealmServerOpCode.MonstVisible)) //4013
            {
                ...
                packet.WriteInt32(1); //value name : unk6 default value : 91Len : 4
        ...
        public static void SendRemoveItemResponse(Character chr, int x ,int y)
        {
        ...
        public static void SendWhoIsHereListResponse(IRealmClient client)
        {
            var characters =
                client.ActiveCharacter.Map.Characters.Where(
                    ...
                    ToList();
            client.ActiveCharacter.UpdateTitleCounter(0 , 10, 100);
        ...
        public static void SendFriendAddedResponse(IRealmClient client, bool success, Character friend)
        {
            using (var packet = new RealmPacketOut(RealmServerOpCode.FriendAdded)) //4151
            {
                ...
                packet.WriteByte((byte)(friend == null ? 0 : friend.ProfessionLevel)); //{profLevel}default value : 23 Len : 1
        ...
        {
            packet.Position += 11;//default : Len : 20
            var inviteSessionId = packet.ReadInt16();//default : 143Len : 2
            var isOk = packet.ReadByte() == 1;//default : 1Len : 1

            Character inviter = client.ActiveCharacter.CurrentFriendInviter;
            if (!isOk)
            {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        if (client.ActiveCharacter.CurrentFriendInviter != null)
                            client.ActiveCharacter.CurrentFriendInviter.SendInfoMsg("2Failed to make friend with " + client.ActiveCharacter.Name);
                    }
                    else
                    {
        ...
        public static void DeleteFromFriendListRequest(IRealmClient client, RealmPacketIn packet)
        {
            ...
            if (client.ActiveCharacter.Friends.ContainsKey(targetAccId))
            {
                lock (client.ActiveCharacter.Friends)
                {
                    ...
                    chr.Friends.Remove(client.ActiveCharacter.AccId);
                    var rec1 = client.ActiveCharacter.FriendRecords.FirstOrDefault(f => f.FirstCharacterAccId == client.ActiveCharacter.AccId &&
                                                                    f.SecondCharacterAccId == targetAccId);
                    var rec2 = client.ActiveCharacter.FriendRecords.FirstOrDefault(f => f.FirstCharacterAccId == targetAccId &&
                                                                    f.SecondCharacterAccId == client.ActiveCharacter.AccId);
                    if (rec1 != null)
                    {
        ...
        public static void TeleportByCristalRequest(IRealmClient client, RealmPacketIn packet)
        {
            ...
            client.ActiveCharacter.SendErrorMsg(" رقم المكان = " + placeNum);
            ...
            {
                client.ActiveCharacter.SendInfoMsg("لا يوجد ذهب كاف.");
                return;
            }
        ...
        public static void SendTeleportedByCristalResponse(IRealmClient client, MapId map, short x, short y, TeleportByCristalStaus staus = TeleportByCristalStaus.Ok)
        {
            using (var packet = new RealmPacketOut(RealmServerOpCode.TeleportedByCristal)) //5055
            {
                ...
                packet.WriteInt16(0); //value name : unk90 default value : 0Len : 2
    ...
    public static class Asda2TeleportMgr
    {
        ...
        {
            Teleports.Add(1, new Asda2TeleportCristalVector { To = new Vector3(1295, 1235), Price = 1500, ToMap = MapId.RainRiver });
            Teleports.Add(3, new Asda2TeleportCristalVector { To = new Vector3(3154, 3357), Price = 5000, ToMap = MapId.Alpia });
            Teleports.Add(0, new Asda2TeleportCristalVector { To = new Vector3(381, 404), Price = 3000, ToMap = MapId.Silaris });
            Teleports.Add(7, new Asda2TeleportCristalVector { To = new Vector3(7135, 7188), Price = 1500, ToMap = MapId.Flamio });
            ...
            Teleports.Add(6, new Asda2TeleportCristalVector { To = new Vector3(6123, 6091), Price = 1500, ToMap = MapId.SunnyCoast });
    ...
    public static class Asda2TeleportHandler
    {
        ...
        public static void DisplayItemRequest(IRealmClient client, RealmPacketIn packet)
        {
            ...
            if (item == null)
            {
                client.ActiveCharacter.SendInfoMsg("لم يتم ايجاد الاداة.");
                return;
            }
        ...
        public static void GetCharecterInfoRequest(IRealmClient client, RealmPacketIn packet)
        {
            ...
            client.ActiveCharacter.UpdateTitleCounter((Asda2TitleId)46, 1000, 3000);
        ...
        public static void SendCharacterFullInfoResponse(IRealmClient client, Character target)
        {
            using (var packet = new RealmPacketOut(RealmServerOpCode.CharacterFullInfo)) //5479
            {
                ...
                packet.WriteByte((byte)target.Archetype.ClassId); //{class}default value : 7 Len : 1
