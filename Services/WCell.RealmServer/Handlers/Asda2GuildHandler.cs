...
namespace WCell.RealmServer.Handlers
{
    public static class Asda2GuildHandler
    {
        ...
        public static void CreateGuildRequest(IRealmClient client, RealmPacketIn packet)
        {
            ...
            client.ActiveCharacter.UpdateTitleCounter((Constants.Achievements.Asda2TitleId)3, 1, 1);
        }
        ...
        public static void SendGuildCreatedResponse(IRealmClient client, CreateGuildStatus status, Guild guild)
        {
            using (var packet = new RealmPacketOut(RealmServerOpCode.GuildCreated)) //4110
            {
                ...
                packet.WriteByte(client.ActiveCharacter.CharNum); //{charNum}default value : 11 Len : 1
        ...
        public static void SendGuildInfoOnLoginResponse(Character rcvChar, Guild guild)
        {
            ...
            {
                packet.WriteInt16(1); //value name : unk default value : 2Len : 2 - Leave
                packet.WriteFixedAsciiString(guild.Name, 17); //{guildName}default value :  Len : 17   
                packet.WriteByte(1); //value name : unk default value : 2Len : 2 - Leave
                packet.WriteFixedAsciiString(guild.Leader.Name, 20); //{guildLeaderName}default value :  Len : 20
                packet.WriteByte(guild.ClanCrest[0] != 0 ? 1 : 0); //value name : unk default value : 2Len : 2 - Leave
                packet.WriteInt16(guild.ClanCrest[0] != 0 ? 1 : 0); //value name : unk default value : 2Len : 2 - Leave
                packet.WriteInt32(guild.ClanCrest[0] != 0 ? 1 : 0); //{guildId}default value : 1436 Len : 2 16 - Id
                packet.WriteInt16(0); //{guildLevel}default value : 1 Len : 2 16  - Crest
                packet.WriteInt32(guild.MemberCount); //{maxMembers}default value : 15 Len : 1 - Level
                packet.WriteInt32(guild.Points); //{membersCount}default value : 2 Len : 1 - MembersCount
                packet.WriteByte(4);
                packet.WriteByte(guild.ClanCrest[0] != (byte)0 ? 1 : 0);
                packet.Write(guild.ClanCrest[0] != (byte)0 ? guild.ClanCrest : stab38);
                packet.WriteInt32(guild.ClanCrest[0] != 0 ? 1 : 0); //TODO New Eng Version!!!
                packet.WriteByte(guild.ClanCrest[0] != 0 ? 1 : 0); //value name : unk default value : 2Len : 2 - Leave
                packet.WriteInt16(guild.ClanCrest[0] != 0 ? 1 : 0); //value name : unk default value : 2Len : 2 - Leave
                packet.WriteInt32(guild.ClanCrest[0] != 0 ? 1 : 0); //{guildId}default value : 1436 Len : 2 16 - Id
                packet.WriteByte(guild.ClanCrest[0] != 0 ? 1 : 0); //value name : unk default value : 2Len : 2 - Leave
            ...
            foreach (var member in members)
            {
                using (var packet = new RealmPacketOut(RealmServerOpCode.GuildMembersInfo)) //4107
                {
                    for (int i = 0; i < member.Count; i += 1)
                    {
                        ...
                        packet.WriteFixedAsciiString(m.Name, 20); //{memberName}default value :  Len : 20 // Name
                        packet.WriteByte(1); //{Gender}default value : 11 Len : 1 // Gender
                        packet.WriteByte((byte)m.Level); //{level}default value : 20 Len : 1 // Level
                        packet.WriteByte((byte)1); //{Unk}default value : 20 Len : 1
                        packet.WriteByte((byte)m.Class); //{Class}default value : 23 Len : 1 // Class
                        packet.WriteInt32((byte)2); //{Unk}default value : 7 Len : 1 // Unk
                        packet.WriteInt32(m.RankId); //{Rank}default value : 7 Len : 1 // Rank
                        packet.WriteInt32(2); //{rank}default value : 4 Len : 1
                        packet.WriteInt16(2); //{rank}default value : 4 Len : 1
                        packet.WriteInt16(2); //{rank}default value : 4 Len : 1
                        packet.WriteInt16(2); //{rank}default value : 4 Len : 1
                        packet.WriteByte(2); //{rank}default value : 4 Len : 1
                        packet.WriteByte(2); //{rank}default value : 4 Len : 1
                        packet.WriteByte(2); //{rank}default value : 4 Len : 1
                        packet.WriteByte(2); //{rank}default value : 4 Len : 1
                        packet.WriteByte(2); //{rank}default value : 4 Len : 1
                        packet.WriteByte(2); //{rank}default value : 4 Len : 1
                        packet.WriteAsdaString(m.PublicNote, 60); //{PublicNote}default value : joinTimeString Len : 17 // PublicNote
                        packet.WriteByte(chr == null ? 0 : 1); //{rank}default value : 4 Len : 1
                        packet.WriteByte((byte)2); //{rank}default value : 4 Len : 1
                        packet.WriteInt32((byte)2); //{rank}default value : 4 Len : 1
                        packet.WriteInt32((byte)2); //{rank}default value : 4 Len : 1
                        packet.WriteInt32((byte)2); //{rank}default value : 4 Len : 1
                        packet.WriteInt32((byte)2); //{rank}default value : 4 Len : 1
                    }
        ...
        {
            packet.Position -= 9;
            var targetSessionId = packet.ReadUInt16(); //default : 355772Len : 4
            Character inviter = client.ActiveCharacter;
            Character invitee = World.GetCharacterBySessionId(targetSessionId);
            Guild guild = inviter.Guild;

            client.ActiveCharacter.SendErrorMsg(string.Format("Invitee : {0}", invitee.AccId));
        ...
        public static void RegisterGuildCrestRequest(IRealmClient client, RealmPacketIn packet)
        {
            ...
            //Console.WriteLine(BitConverter.ToString(packet.ReadBytes(6)));
            packet.Position -= 6;
        ...
        public static void JoinGuildResponseRequest(IRealmClient client, RealmPacketIn packet)
        {
            ...
            chr.UpdateTitleCounter((Constants.Achievements.Asda2TitleId)4, 1, 1);
        }
        ...
        public static void SendUpdateGuildInfoResponse(Guild guild, GuildInfoMode mode = GuildInfoMode.Silent, Character rcv = null)
        {
            ...
            if (rcv != null)
                using (var packet = new RealmPacketOut(RealmServerOpCode.UpdateGuildInfo)) //4121
                {
                    ...
                    packet.WriteInt32(guild.MemberCount); //{maxMembers}default value : 15 Len : 1 - Level
                    packet.WriteInt32(guild.Points); //{membersCount}default value : 2 Len : 1 - MembersCount
                    packet.WriteInt32(guild.Points); //{guildPoints}default value : 141 Len : 4 - Points
                    packet.WriteInt32(1); //TODO New Eng Version!!!
                    packet.WriteInt32(1); //value name : unk2 default value : 0Len : 2
                    packet.WriteInt32(1); //value name : unk12 default value : 96Len : 2
                    packet.WriteInt32(1); //value name : unk13 default value : 120Len : 2
                    packet.WriteInt32(1); //value name : unk14 default value : 127Len : 2
                    packet.WriteInt32(1); //value name : unk2 default value : 0Len : 2
                    packet.WriteInt32(1); //value name : unk12 default value : 96Len : 2
                    packet.WriteInt32(1); //value name : unk13 default value : 120Len : 2
                    packet.WriteInt32(1); //value name : unk14 default value : 127Len : 2
            ...
            else
            {
                ...
                using (var packet = new RealmPacketOut(RealmServerOpCode.UpdateGuildInfo)) //4121
                {
                    packet.WriteInt16(2); //value name : unk default value : 2Len : 2 - Leave
                    packet.WriteFixedAsciiString(guild.Name, 17); //{guildName}default value :  Len : 17   
                    packet.WriteByte((byte)mode); //value name : unk default value : 2Len : 2 - Leave
                    packet.WriteFixedAsciiString(guild.Leader.Name, 20); //{guildLeaderName}default value :  Len : 20
                    packet.WriteByte(2); //value name : unk default value : 2Len : 2 - Leave
                    packet.WriteInt16((byte)mode); //value name : unk default value : 2Len : 2 - Leave
                    packet.WriteInt32(guild.ClanCrest[0] != 0 ? 1 : 0); //{guildId}default value : 1436 Len : 2 16 - Id
                    packet.WriteInt16(0); //{guildLevel}default value : 1 Len : 2 16  - Crest
                    packet.WriteInt32(guild.MemberCount); //{maxMembers}default value : 15 Len : 1 - Level
                    packet.WriteInt32(guild.Points); //{membersCount}default value : 2 Len : 1 - MembersCount
                    packet.WriteInt32(guild.Points); //{guildPoints}default value : 141 Len : 4 - Points
                    packet.WriteInt16(1); //TODO New Eng Version!!!
        ...
        public static void WritePublicGuildMemberNoteRequest(IRealmClient client, RealmPacketIn packet)
        {
            ...
            packet.Position -= 3;
            var message = packet.ReadAsdaString(64, Locale.Any);//default : Len : 64
            ...
            SendUpdateGuildInfoResponse(client.ActiveCharacter.Guild, GuildInfoMode.Silent, client.ActiveCharacter);
        ...
        public static void SendClanFlagAndClanNameInfoSelfResponse(Character chr)
        {
            /*using (var packet = new RealmPacketOut(RealmServerOpCode.ClanFlagAndClanNameInfoSelf))//4105
            {
                ...
                packet.WriteInt32(2);//{guildId}default value : 471 Len : 2
                packet.WriteByte(chr.Guild.ClanCrest[0] != 0 ? 1 : 0);
                packet.WriteSkip(chr.Guild.ClanCrest[0] != 0 ? chr.Guild.ClanCrest : Unk13);//value name : unk13 default value : unk13Len : 40
        ...
        public static void SendGuildNotificationResponse(Guild guild, GuildNotificationType status, GuildMember trigerer)
        {
            ...
            using (var packet = new RealmPacketOut(RealmServerOpCode.GuildNotification))//4122
            {
                ...
                packet.WriteByte(trigerer.RankId);//{rank}default value : 11 Len : 1
