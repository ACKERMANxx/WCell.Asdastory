...
namespace WCell.RealmServer.Handlers
{
    public static class Asda2SoulmateHandler
    {
        ...
        {
            packet.Position -= 9;
            var message = packet.ReadAsdaString(127,Locale.En); //default : Len : 127
        ...
        public static void AnswerSoulmateRequestRequest(IRealmClient client, RealmPacketIn packet)
        {
            ...
            var chr = client.ActiveCharacter;
            packet.Position -= 17; //nk7 default : 0Len : 1
            ...
            client.ActiveCharacter.SendErrorMsg(string.Format("Status = {0}", status));
            client.ActiveCharacter.SendErrorMsg(string.Format("TSMname = {0}", targetSoulmateName));
            var targetChr = World.GetCharacter(targetSoulmateName, true);
            if (targetChr == null)
            {
                client.ActiveCharacter.SendSystemMessage(string.Format("Cant add soulmate cause not found by name {0}",
        ...
        public static void DisbandSoulMateRequest(IRealmClient client, RealmPacketIn packet)
        {
            ...
            if (chr.IsSoulmated)
            {
                if (chr.SoulmateRecord.Level >= 10)
                    client.ActiveCharacter.UpdateTitleCounter((Asda2TitleId)2, 10, 30);
        ...
        public static void SendSoulmateEnterdGameResponse(IRealmClient client)
        {
            ...
            using (var packet = new RealmPacketOut(RealmServerOpCode.SoulmateEnterdGame)) //5110
            {
                ...
                packet.WriteByte(1); //value name : unk1 default value : 1Len : 1
                packet.WriteByte(1); //value name : unk10 default value : 10Len : 1
                ...
                packet.WriteByte(1); //value name : unk18 default value : 132Len : 1
                packet.WriteByte(1); //value name : unk19 default value : 111Len : 1
        ...
        public static void SendSoulmateBuffUpdateInfoResponse(Character chr)
        {
            using (var packet = new RealmPacketOut(RealmServerOpCode.SoulmateBuffUpdateInfo))//5112
            {
                ...
                for (int i = 0; i < 28; i += 1)
                {
                    ...
                    packet.WriteByte(aura == null ? 0 :(aura.TimeLeft > 5000 ? 0 : 1));//spadaet?
        ...
        public static void SendSoulmatePositionResponse(IRealmClient client)
        {
            ...
            using (var packet = new RealmPacketOut(RealmServerOpCode.SoulmatePosition)) //5223
            {
                ...
                packet.WriteInt32(client.ActiveCharacter.SessionId); //{soulmateAccId}default value : 355929 Len : 4
                packet.WriteInt16((short)client.ActiveCharacter.Asda2X * 100); //{x}default value : 90 Len : 2
                packet.WriteInt16((short)client.ActiveCharacter.Asda2Y * 100); //{y}default value : 243 Len : 2
                packet.WriteInt16((short)client.ActiveCharacter.MapId); //{y}default value : 243 Len : 2
        ...
        {
            client.ActiveCharacter.UpdateTitleCounter((Asda2TitleId)16, 1000, 3000);
        ...
        public static void EatAppleRequest(IRealmClient client, RealmPacketIn packet)
        {
            ...
            client.ActiveCharacter.UpdateTitleCounter((Asda2TitleId)1, 100, 500);
        }
        ...
        public static void SendSoulmateMessageRequest(IRealmClient client, RealmPacketIn packet)
        {
            ...
            {
                SendIncomingSoulmateMessageResponse(client.ActiveCharacter.SoulmateCharacter, msg, Locale.Any, DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day, DateTime.Now.Hour, DateTime.Now.Minute);
                SendSoulmatemessageSendedResponse(client);
                client.ActiveCharacter.UpdateTitleCounter((Asda2TitleId)17, 200, 500);
            }
            else
            {
                client.ActiveCharacter.SendInfoMsg("Sry we can't send message to your soulmate while he is offline.");
            }
        }
        ...
        public static void SendIncomingSoulmateMessageResponse(Character c,string msg,Locale locale, int year, int month, int day, int hour, int minute)
        {
            using (var packet = new RealmPacketOut(RealmServerOpCode.IncomingSoulmateMessage))//6055
            {
                ...
                packet.WriteInt32(year);//{year}default value : 2012 Len : 4
                packet.WriteInt32(month);//{mounth}default value : 10 Len : 4
                packet.WriteInt32(day);//{day}default value : 12 Len : 4
                packet.WriteInt32(hour);//{hour}default value : 14 Len : 4
                packet.WriteInt32(minute);//{minute}default value : 52 Len : 4
                c.Send(packet);
            }
        }
        ...
        public static void UseSoulmateSkillRequest(IRealmClient client, RealmPacketIn packet)
        {
            ...
            var targetSessId = client.ActiveCharacter.SoulmateCharacter.SessionId;//default : 5Len : 2
            client.ActiveCharacter.SendErrorMsg("PP : " + packet.Position);
            client.ActiveCharacter.SendErrorMsg("SkillId : " + skillId);
            client.ActiveCharacter.SendErrorMsg("Target : " + targetSessId);
            if (client.ActiveCharacter.SoulmateCharacter==null)
            {
            ...
            {
                SendSoulmateSkillUsedResponse(client, UseSoulmateSkillStatus.FriendNakazan, 0, 0);
                return;
            }
        }
        ...
        public static void SendSoulmateSkillUsedResponse(IRealmClient client,UseSoulmateSkillStatus status,short skillId,short targetSessId)
        {
            using (var packet = new RealmPacketOut(RealmServerOpCode.SoulmateSkillUsed))//5234
            {
                ...
                packet.WriteInt16(skillId);//value name : unk8 default value : unk8Len : 112
        ...
        public static void SendSoulmateSummoningYouResponse(Character summoner, Character friend)
        {
            ...
            using (var packet = new RealmPacketOut(RealmServerOpCode.SoulmateSummoningYou))//5236
            {
                ...
                packet.WriteInt16((short)summoner.Asda2X);//{x}default value : 96 Len : 2
                packet.WriteInt16((short)summoner.Asda2Y);//{y}default value : 253 Len : 2
    ...
    {
        public Asda2SoulmateSkillCall() : base(Asda2SoulmateSkillId.Call, 5,1200)
        {
        }
    ...
    public class Asda2SoulmateSkillSafeHands : Asda2SoulmateSkill
    {
        public Asda2SoulmateSkillSafeHands() : base(Asda2SoulmateSkillId.SafeHands, 4, 43200)
        {
        }
        public override bool TryCast(Character caster, Character friend)
        {
    ...
    public class Asda2SoulmateSkillTeleport : Asda2SoulmateSkill
    {
        public Asda2SoulmateSkillTeleport()
            : base(Asda2SoulmateSkillId.Teleport, 20, 1200)
        {
        }
        public override bool TryCast(Character caster, Character friend)
        {
    ...
    {
        public Asda2SoulmateSkillHeal() : base(Asda2SoulmateSkillId.Heal, 25, 15)
        {
        }
        public override bool TryCast(Character caster, Character friend)
        {
    ...
    public class Asda2SoulmateSkillEmpower : Asda2SoulmateSkill
    {
        public Asda2SoulmateSkillEmpower()
            : base(Asda2SoulmateSkillId.Empower1, 27, 60)
        {
        }
        public override bool TryCast(Character caster, Character friend)
        {
    ...
    public class Asda2SoulmateSkillResurect : Asda2SoulmateSkill
    {
        public Asda2SoulmateSkillResurect()
            : base(Asda2SoulmateSkillId.Resurect, 18, 600)
        {
        }
        public override bool TryCast(Character caster, Character friend)
        {
    ...
    public class Asda2SoulmateSkillSoulSong : Asda2SoulmateSkill
    {
        public Asda2SoulmateSkillSoulSong()
            : base(Asda2SoulmateSkillId.SoulSong, 30, 43200)
        {
        }
        public override bool TryCast(Character caster, Character friend)
        {
