...
namespace WCell.RealmServer.Spells
{
	...
	public static partial class SpellHandler
	{
		...
		static void InitEffectHandlers()
		{
			...
			SpellEffectCreators[(int)SpellEffectType.WeaponDamage] = (cast, effect) => new WeaponDamageEffectHandler(cast, effect);									// 60
            ...
            SpellEffectCreators[(int)SpellEffectType.DamageFromPrcAtack] = (cast, effect) => new DamageFromPrcAtackHandler(cast, effect);						// 162
            SpellEffectCreators[(int)SpellEffectType.CastAnotherSpell] = (cast, effect) => new CastAnotherSpellHandler(cast, effect);						// 162
            SpellEffectCreators[(int)SpellEffectType.PortalTeleport] = (cast, effect) => new PortalTeleportEffectHandler(cast, effect);
            SpellEffectCreators[(int)SpellEffectType.BossSummonHelp] = (cast, effect) => new BossSummonHelpSpellHandler(cast, effect);
