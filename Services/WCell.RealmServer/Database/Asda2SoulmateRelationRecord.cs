...
namespace WCell.RealmServer.Database
{
    ...
    public class Asda2SoulmateRelationRecord : WCellRecord<Asda2SoulmateRelationRecord>
    {
        ...
        void InitSkills()
        {
            ...
            Skills.Add(Asda2SoulmateSkillId.SafeHands, new Asda2SoulmateSkillSafeHands());
        ...
        private void TryLevelUp()
        {
            ...
            if (Level == 30)
            {
                firstChar.UpdateTitleCounter((Constants.Achievements.Asda2TitleId)5, 1, 1);
                secChar.UpdateTitleCounter((Constants.Achievements.Asda2TitleId)5, 1, 1);
            }
            if (Level >= 10)
            {
                firstChar.AsdaStoryDiscoverTitle((Constants.Achievements.Asda2TitleId)5);
                secChar.AsdaStoryDiscoverTitle((Constants.Achievements.Asda2TitleId)5);
            }
        }
