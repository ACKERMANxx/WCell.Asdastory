...
namespace WCell.RealmServer.Database
{
    ...
    public class Asda2ItemRecord : WCellRecord<Asda2ItemRecord>
	{
        ...
        [Property]
        public byte EnchantChances { get; set; }
        [Property]
        public byte EnchantCount { get; set; }
        [Property]
        public byte EnchantLevel { get; set; }
        [Property]
        public int FailedEnchants { get; set; }
        ...
        public static Asda2ItemRecord CreateRecord(Asda2ItemTemplate templ)
		{
            ...
            item.EnchantChances = templ.EnchantChances;
            item.EnchantCount = 0;
            item.EnchantLevel = templ.EnchantLevel;
