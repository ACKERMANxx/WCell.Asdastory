    ...
    public static class Asda2BattlegroundHandler
    {
        ...
        public static void SendUpdateWarManagerScreenDataResponse(IRealmClient client, Asda2Battleground btlgrnd)
        {
            using (var packet = new RealmPacketOut(RealmServerOpCode.UpdateWarManagerScreenData)) //6701
            {
                ...
                packet.WriteInt16(btlgrnd.ChaosTeam.Count); //{forChaosPeople}default value : 2 len : 2
                ...
                packet.WriteInt16(btlgrnd.ChaosWins); //{winWarsChaos}default value : 457 len : 2
                ...
                packet.WriteInt16(btlgrnd.ChaosLooses); //{chaosLoses}default value : 457 len : 2
                packet.WriteInt16(btlgrnd.LightWins + btlgrnd.LightLooses); //{totalWars}default value : 1187 Len : 2
                packet.WriteByte(btlgrnd.CurrentWarDurationMins); //{dailyWarsMinusOne}default value : 0 Len : 1
        ...
        public static void RegisterToWarRequest(IRealmClient client, RealmPacketIn packet)
        {
            ...
            if (client.ActiveCharacter.Asda2FactionId < 0 || client.ActiveCharacter.Asda2FactionId > 2)
            {
        ...
        public static void SendRegisteredToWarResponse(IRealmClient client, RegisterToBattlegroundStatus status)
        {
            using (var packet = new RealmPacketOut(RealmServerOpCode.RegisteredToWar)) //6707
            {
                ...
                packet.WriteInt16(client.ActiveCharacter.Battlegrounds.RelationCount); //{place}default value : 3 Len : 2
                packet.WriteInt16(0 /*client.ActiveCharacter.CurrentBattleGround.AmountOfBattleGroundsInList*/); //{battleField}default value : 1 Len : 2
                client.Send(packet);
            }
        }
        ...
        public static void SendSomeOneKilledSomeOneResponse(Asda2Battleground btlgrnd, int points, Character Killer, Character Victim)
        {
            using (var packet = new RealmPacketOut(RealmServerOpCode.SomeOneKilledSomeOne)) //6730
            {
                packet.WriteInt16(Killer.SessionId); //{killerAccId}default value : 315044 Len : 4
                packet.WriteInt16(Victim.SessionId); //{killerAccId}default value : 315044 Len : 4
                packet.WriteInt16(1); //value name : unk7 default value : 1Len : 4
                packet.WriteInt32(points); //{killerWarId}default value : 8 Len : 4
                packet.WriteFixedAsciiString(Killer.Name, 20); //{killerName}default value :  Len : 20
                packet.WriteFixedAsciiString(Victim.Name, 20); //{vicimName}default value :  Len : 20
        ...
        public static void SendTeamPointsResponse(Asda2Battleground btlgrnd,Character chr = null)
        {
            using (var packet = new RealmPacketOut(RealmServerOpCode.TeamPoints)) //6729
            {
                ...
                packet.WriteInt32(btlgrnd.ChaosScores); //{chaos}default value : 613 len : 4
                if(chr!=null)
        ...
        public static void SendWarChatResponseResponse(Asda2Battleground btlgrnd, string senderName, string message, int factionId, Locale locale)
        {
            using (var packet = new RealmPacketOut(RealmServerOpCode.WarChatResponse)) //6719
            {
                ...
                packet.WriteFixedAsciiString(senderName, 2); //{senderName}default value :  Len : 20
        ...
        public static void SendHowManyPeopleInWarTeamsResponse(Asda2Battleground btlgrnd,Character chr =null)
        {
            using (var packet = new RealmPacketOut(RealmServerOpCode.HowManyPeopleInWarTeams)) //6742
            {
                ...
                packet.WriteInt16(btlgrnd.ChaosTeam.Count); //{chaos}default value : 28 len : 2
                if(chr!=null)
                    chr.Send(packet,addEnd: true);
                else 
                    btlgrnd.Send(packet, addEnd: true);
        ...
        public static void SendWarEndedResponse(IRealmClient client, byte winingFaction, int LightScores,
                                                int DarkScores, int ChaosScores, int honorPoints, short honorCoin,
                                                long expReward, string mvpName)
        {
            using (var packet = new RealmPacketOut(RealmServerOpCode.WarEnded)) //6732
            {
                ...
                packet.WriteInt32(101); //{LightFactionPoints}default value : 911 Len : 4
                packet.WriteInt32(102); //{LightFactionPoints}default value : 911 Len : 4
                packet.WriteInt32(103); //{LightFactionPoints}default value : 911 Len : 4

                packet.WriteInt32(100); //{LightFactionPoints}default value : 911 Len : 4
                packet.WriteInt32(120); //{DarkFactionPoints}default value : 120 Len : 4
                packet.WriteInt32(130); //{ChaosFactionPoints}default value : 120 len : 4
                packet.WriteInt32(400); //{HonorPoints}default value : 353 Len : 4
                packet.WriteInt16(500); //{honorCoin}default value : 17 Len : 2
                packet.WriteSkip(stab35); //value name : stab35 default value : stab35Len : 3
                packet.WriteInt64(600); //{expReward}default value : 10000 Len : 8
        ...
        public static void SendWarEndedOneResponse(IRealmClient client, IEnumerable<Asda2Item> prizeItems)
        {
            ...
            using (var packet = new RealmPacketOut(RealmServerOpCode.WarEndedOne)) //6733
            {
                ...
                {
                    var item = items[i];
                    PacketStructureSegments.ItemInformation(client, packet, item);
                }
                client.Send(packet, addEnd: true);
            }
        }
        ...
        public static void SendWarTeamListResponse(Character chr)
        {
            ...
            lock (btldrnd.JoinLock)
            {
                ...
                else if (chr.Asda2FactionId == 2)
                {
                    var listsCount = btldrnd.ChaosTeam.Count / 6;
                    if (listsCount == 0)
                        listsCount = 1;
                    for (int i = 0; i < listsCount; i++)
                    {
                        chrsLists.Add(btldrnd.ChaosTeam.Values.Skip(i * 6).Take(6).ToList());
                    }
                }
                foreach (var chrsList in chrsLists)
                {
                    ...
                    {
                        Character leader = chrsList.First();
                        foreach (var character in chrsList)
                        {
                            ...
                            if (character == leader)
                            {
                                packet.WriteByte(character.CurrentBattleGround.IsLeader); //{warLeader}default value : 3Len : 1
                                character.ChatColor = Util.Graphics.Color.Orange;
                            }
                            else
                            {
                                packet.WriteByte(3);
                            ...
                            //packet.WriteFixedAsciiString(character.Guild == null ? "" : character.Guild.Name, 24); //{deathes}default value : 0 Len : 2
                            ...
                            packet.WriteFixedAsciiString(character.IsInGroup ? character.Group.Leader.Name : "", 24); //{clanName}default value :  Len : 17
          ...
          //  var charACCiD = packet.ReadInt32();//default : 357812Len : 4
            ...
            using (var p = new RealmPacketOut(RealmServerOpCode.DismissPlayerFromWarRequestResult))//6187
            {
                if (target == null || !client.ActiveCharacter.CurrentBattleGround.TryStartDissmisProgress(client.ActiveCharacter,target) || client.ActiveCharacter.Money < 10000)
                {
                    ...
                    PacketStructureSegments.ItemInformation(client, p, null);
                }
                else
                {
                    ...
                    p.WriteInt16(client.ActiveCharacter.Asda2Inventory.Weight);//{invWeight}default value : 10665 Len : 2
                    PacketStructureSegments.ItemInformation(client, p, client.ActiveCharacter.Asda2Inventory.GetRegularItem(0));
