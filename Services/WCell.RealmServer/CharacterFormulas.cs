...
namespace WCell.RealmServer
{
    ...
    public static class CharacterFormulas
    {
        ...
        [NotVariable]
        public static int OptionStatStartsWithEnchantValue = 6;
        [NotVariable]
        public static float ItemsDeffenceMultiplier = 1.5f;
        [NotVariable]
        public static float ItemsMagicDeffenceMultiplier = 4.5f;
        [NotVariable]
        public static float PetDeffenceMultiplier = 2f;
        [NotVariable]
        public static float PetMagicDeffenceMultiplier = 2f;
        [NotVariable]
        ...
        [NotVariable]
        public static float PhysicalAtackSowelMultiplier = 1f;
        [NotVariable]
        ...
        [NotVariable]
        public static float HpPotionsBoostPerStamina = 0.002f;
        [NotVariable]
        public static int MaxLvlMobCharDiff = 6;
        [NotVariable]
        public static int MaxDamagersDetailCount = 5;
        [NotVariable]
        public static int EventItemsForGuessEvent = 10;
        [NotVariable]
        public static int EventItemId = 33800;
        [NotVariable]
        public static int DonationItemId = 33800;
        [NotVariable]
        public static int RebornLevel = 100;
        [NotVariable]
        public static int DefenceTownLives = 100;
        [NotVariable]
        ...
        /// </summary>
        public static float SoulmatExpFromMonstrKilled = 0.3f;
        [NotVariable]
        /// /// <summary>
        /// Сколько дается опыта дружбы за любое получение опыта в игре(рыбалка копка крафт и т.д)
        /// </summary>
        public static float SoulmatExpFromAnyExp = 0.1f;
        [NotVariable]
        /// <summary>
        /// Опыт дружбы за нахождение рядом
        /// </summary>
        public static float SoulmateExpGainPerMinuteNearFriend = 0.01f;
        [NotVariable]
        /// <summary>
        ...
        /// </summary>
        public static float OnePrcAtackTimeReducePerAgilityPoints = 0.01f;
        [NotVariable]
        /// <summary>
        /// Кол-во ед. удачи для увеличения шанса критического удара на 1%
        /// </summary>
        public static float OnePrcCritPerLuck = 0.003f;
        [NotVariable]
        /// <summary>
        /// Кол-во ед. удачи для увеличения шанса выпадения предмета на 1%
        /// </summary>
        public static float OnePrcDropChancePerLuck = 100.000015f;
        [NotVariable]
        /// <summary>
        /// Кол-во ед. удачи для увеличения кол-ва выпадаемого с монстра золота на 1%
        /// </summary>
        public static float OnePrcGoldAmountPerLuckPoints = 0.0015f;
        [NotVariable]
        /// <summary>
        /// Кол-во ед. Энергии для увеличения магической защиты на 1 ед.
        /// </summary>
        public static float OneMagicDefencePerSpiritPoints = 1f;
        [NotVariable]
        /// <summary>
        /// Кол-во ед. маны за каждое очко Энергии
        /// </summary>
        public static float ManaPointsPerOneSpirit = 2.54f;
        [NotVariable]
        /// <summary>
        /// Кол-во ед. Интелекта для увеличения маг атаки на 1ед.
        /// </summary>
        public static float DamagePerIntelect = 0.48f;
        [NotVariable]
        /// <summary>
        /// Кол-во ед. Ловкости для увеличения атаки атаки на 1ед.
        /// </summary>
        public static float DamagePerAgility = 0.37f;
        [NotVariable]
        /// <summary>
        /// Кол-во ед. Силы для увеличения атаки атаки на 1ед.
        /// </summary>
        public static float DamagePerStrength = 0.35f;
        [NotVariable]
        /// <summary>
        /// Кол-во ед. жизни за каждое очко Силы
        /// </summary>
        public static float HealthPointsPerStrength = 0.000006f;
        [NotVariable]
        /// <summary>
        /// Кол-во ед. жизни за каждое очко Выносливости
        /// </summary>
        public static float HealthPointsPerStamina = 2.5f;
        [NotVariable]
        /// <summary>
        /// Кол-во ед. защиты за каждое очко Ловкости
        /// </summary>
        public static float DefencePointsPerAgility = 0.25f;
        [NotVariable]
        /// <summary>
        /// увеличение шанса уворота за 1 ловкость
        /// </summary>
        public static float DodgePerAgility = 0.005f;
        [NotVariable]
        /// <summary>
        ...
        /// </summary>
        public static float CritDamageBonusPerStrength = 0.001f;
        [NotVariable]
        /// <summary>
        /// Усиление крит урона в % за 1ну ед. Интелекта
        /// </summary>
        public static float CritDamageBonusPerIntellect = 0.001f;
        [NotVariable]
        /// <summary>
        /// Увеличение степени усиления характеристик предмета (Урона) при заточке.
        /// </summary>
        public static float EnchantPowValue = 0.3f;
        [NotVariable]
        /// <summary>
        ...
        /// </summary>
        public static byte StandartFishingChance = 36;
        [NotVariable]
        /// <summary>
        ...
        /// </summary>
        [NotVariable]
        public static float ManaRegenPerSpirit = 0.8f;
        ...
        public static int GetBaseHealth(int level, ClassId cl)
        {
            ...
            {
                case ClassId.OHS:
                    return 250 + level * 17*50;
                case ClassId.THS:
                    return 200 + level * 16 * 50;
                case ClassId.Spear:
                    return 180 + level * 70 * 50;
                case ClassId.Crossbow:
                    return 150 + level * 14 * 50;
                case ClassId.Bow:
                    return 150 + level * 14 * 50;
                case ClassId.Balista:
                    return 150 + level * 15 * 50;
                case ClassId.AtackMage:
                    return 90 + level * 13 * 50;
                case ClassId.SupportMage:
                    return 100 + level * 13 * 50;
                case ClassId.HealMage:
                    return 110 + level * 13 * 50;
        ...
        public static float CalculateHealthBonus(int level, int asda2Strength, int asda2Stamina, ClassId cl)
        {
            ...
            {
                case ClassId.OHS:
                    return asda2Stamina * HealthPointsPerStamina * 1.7f + asda2Strength * HealthPointsPerStrength * 1.25f;
                case ClassId.THS:
                    return asda2Stamina * HealthPointsPerStamina * 1.45f + asda2Strength * HealthPointsPerStrength * 1.05f;
                case ClassId.Spear:
                    return asda2Stamina * HealthPointsPerStamina * 1.4f + asda2Strength * HealthPointsPerStrength * 1f;
                case ClassId.Crossbow:
                    return asda2Stamina * HealthPointsPerStamina * 0.9f + asda2Strength * HealthPointsPerStrength * 0.7f;
                case ClassId.Bow:
                    return asda2Stamina * HealthPointsPerStamina * 0.9f + asda2Strength * HealthPointsPerStrength * 0.7f;
                case ClassId.Balista:
                    return asda2Stamina * HealthPointsPerStamina * 0.9f + asda2Strength * HealthPointsPerStrength * 0.7f;
                case ClassId.AtackMage:
                    return asda2Stamina * HealthPointsPerStamina * 0.55f;
                case ClassId.SupportMage:
                    return asda2Stamina * HealthPointsPerStamina * 0.75f;
                case ClassId.HealMage:
                    return asda2Stamina * HealthPointsPerStamina * 0.75f;
                case ClassId.NoClass:
        ...
        public static float CalculatePsysicCritChance(ClassId id, int level, int luck)
        {
            ...
            {
                case ClassId.OHS:
                    r = luck * OnePrcCritPerLuck * 1.1f;
                    break;
                case ClassId.THS:
                    r = luck * OnePrcCritPerLuck * 0.7f; break;
                case ClassId.Spear:
        ...
        public static float CalculateMagicDamageBonus(int level, ClassId cl, int asda2Intellect)
        {
            ...
            {
                case ClassId.AtackMage:
                    return asda2Intellect * DamagePerIntelect;
                case ClassId.HealMage:
        ...
        public static float CalculatePsysicalDamageBonus(int level, int asda2Agility, int strength, ClassId cl)
        {
            ...
            {
                case ClassId.OHS:
                    return (asda2Agility * DamagePerAgility + strength * DamagePerStrength) * 0.7f;
                case ClassId.THS:
                    return (asda2Agility * DamagePerAgility + strength * DamagePerStrength) * 1.2f;
                case ClassId.Spear:
                    return (asda2Agility * DamagePerAgility + strength * DamagePerStrength) * 1f;
                case ClassId.Crossbow:
                    return (asda2Agility * DamagePerAgility + strength * DamagePerStrength) * 1f;
                case ClassId.Bow:
                    return (asda2Agility * DamagePerAgility + strength * DamagePerStrength) * 1f;
        ...
        public static float CalcSpeedBonus(int level, ClassId cl, int asda2Agility)
        {
            switch (cl)
            {
                ...
                case ClassId.Spear:
                    return asda2Agility * SpeedPerAgility * 0.7f;
                case ClassId.Crossbow:
                    return asda2Agility * SpeedPerAgility;
                case ClassId.Bow:
                    return asda2Agility * SpeedPerAgility;
                case ClassId.Balista:
                    return asda2Agility * SpeedPerAgility;
        ...
        public static ItemUpgradeResult CalculateItemUpgradeResult(Asda2ItemQuality stoneQuality, Asda2ItemQuality itemQuality, byte enchant, byte requiredLevel, int ownerLuck, int groupLuck, int nearblyCharactersLuck, bool useProtect, int useChanceBoost, bool noEnchantLose)
        {
            ...
            if (enchant > 5)
                seed = seed * 0.0f;
            var chance = 0;//(seed + seed * (boostFromOwnerLuck + boostFormGroupLuck + boostFromNearbyCharactersLuck - Math.Pow(requiredLevel, 0.85f) / 100)) * (1 + (float)useChanceBoost / 100);
            if (chance > 100)
                chance = 100;
            if (chance < 0)
                chance = 0;
        ...
        {
            return (float)(enchant == 0 ? 1 : Math.Pow(enchant, EnchantPowValue));
        }
        /// <summary>
        ...
        /// <returns></returns>
        public static bool CalcFishingSuccess(int fishingLevel, int requiredFishingLevel, int asda2Luck, int fishingarrows)
        {
            var boost = (fishingLevel - requiredFishingLevel) * fishingarrows / 3.5f;
        ...
        [NotVariable]
        public static int AlpiaBaseHonorPoints = 5;
        [NotVariable]
        public static int SilarisBaseHonorPoints = 15;
        [NotVariable]
        public static int FlamioBaseHonorPoints = 30;
        [NotVariable]
        public static int AquatonBaseHonorPoints = 60;
        public static int CalcHonorPoints(int level, short battlegroundActPoints, bool isWiner, int battlegroundDeathes, int battlegroundKills, bool isMvp, Asda2BattlegroundTown town)
        {
            switch (town)
            {
                ...
                case Asda2BattlegroundTown.Flamio:
                    return (int)(battlegroundActPoints * Math.Pow(70 - level, 0.2f) *
                                  Math.Pow(
                                      (battlegroundKills <= battlegroundDeathes ? 1 : battlegroundKills - battlegroundDeathes),
                                      0.15f) * (isMvp ? 1.5f : 1) * (isWiner ? 2 : 1) * FlamioBaseHonorPoints);
                case Asda2BattlegroundTown.Aquaton:
                    return (int)(battlegroundActPoints * Math.Pow(100 - level, 0.2f) *
                                  Math.Pow(
                                      (battlegroundKills <= battlegroundDeathes ? 1 : battlegroundKills - battlegroundDeathes),
                                      0.15f) * (isMvp ? 1.5f : 1) * (isWiner ? 2 : 1) * FlamioBaseHonorPoints);
            }
        ...
        [NotVariable]
        public static int PKItemDropChance = 0;
        [NotVariable]
        ...
        public static short CalcBattlegrounActPointsOnKill(int killerLevel, int victimLevel, short killerActPoints, short victimActPoints)
        {
            ...
            var points = 3 * Math.Pow(Math.Abs(actPointsDiff), 0.35f);
        ...
        public static int GetSowelDeffence(int value, Asda2Profession requiredProfession)
        {
            switch (requiredProfession)
            {
                ...
                case Asda2Profession.Archer:
                    return (int)(value * 3f * ItemsDeffenceMultiplier);
                case Asda2Profession.Mage:
                    return (int)(value * 1.3f * ItemsDeffenceMultiplier);
                case Asda2Profession.Warrior:
                    return (int)(value * 6.75f * ItemsDeffenceMultiplier);
                case Asda2Profession.NoProfession:
                    return (int)(value * 0.15f * ItemsDeffenceMultiplier);
                default:
                    return 0;
            }
        }
