...
namespace WCell.Core.Network
{
    ...
    public class PrimitiveWriter : BinaryWriter
    {
        ...
        public Locale EncodedLocale = Locale.UnEncoded;
        public Locale TextLocale;
        private readonly SegmentStream _segmentStream;
        public BufferSegment BufferSegment { get { return _segmentStream.Segment; } }
        ...
        {
            _segmentStream.Position = 0;
            //BufferSegment.DecrementUsage();
