...
namespace WCell.Constants.World
{
	public static class MapBoundaries 
	{
		public static BoundingBox[] GetMapBoundaries()
		{
            ...
            boxes[(int)MapId.Silaris] = new BoundingBox(new Vector3(0, 0, -2048f), new Vector3(500, 500, 2048f));
            boxes[(int)MapId.RainRiver] = new BoundingBox(new Vector3(1000, 1000, -2048f), new Vector3(1500, 1500, 2048f));
            boxes[(int)MapId.ConquestLand] = new BoundingBox(new Vector3(2000, 2000, -2048f), new Vector3(2500, 2500, 2048f));
            boxes[(int)MapId.Alpia] = new BoundingBox(new Vector3(3000, 3000, -2048f), new Vector3(3500, 3500, 2048f));
            boxes[(int)MapId.NightValey] = new BoundingBox(new Vector3(4000, 4000, -2048f), new Vector3(4500, 4500, 2048f));
            boxes[(int)MapId.Aquaton] = new BoundingBox(new Vector3(5000, 5000, -2048f), new Vector3(5500, 5500, 2048f));
            boxes[(int)MapId.SunnyCoast] = new BoundingBox(new Vector3(6000, 6000, -2048f), new Vector3(6500, 6500, 2048f));
            boxes[(int)MapId.Flamio] = new BoundingBox(new Vector3(7000, 7000, -2048f), new Vector3(7500, 7500, 2048f));
            boxes[(int)MapId.QueenPalace] = new BoundingBox(new Vector3(8000, 8000, -2048f), new Vector3(8500, 8500, 2048f));
            boxes[(int)MapId.CastleOfChess] = new BoundingBox(new Vector3(9000, 9000, -2048f), new Vector3(9500, 9500, 2048f));
            boxes[(int)MapId.FlamioPlains] = new BoundingBox(new Vector3(10000, 10000, -2048f), new Vector3(10500, 10500, 2048f));
            boxes[(int)MapId.NeptillanNode] = new BoundingBox(new Vector3(11000, 11000, -2048f), new Vector3(11500, 11500, 2048f));
            boxes[(int)MapId.FlamionMoutain] = new BoundingBox(new Vector3(12000, 12000, -2048f), new Vector3(12500, 12500, 2048f));
            boxes[(int)MapId.Flabis] = new BoundingBox(new Vector3(13000, 13000, -2048f), new Vector3(13500, 13500, 2048f));
            boxes[(int)MapId.StagnantDesert] = new BoundingBox(new Vector3(14000, 14000, -2048f), new Vector3(14500, 14500, 2048f));
            boxes[(int)MapId.DragonLair] = new BoundingBox(new Vector3(15000, 15000, -2048f), new Vector3(15500, 15500, 2048f));
            boxes[(int)MapId.FirewayForest] = new BoundingBox(new Vector3(16000, 16000, -2048f), new Vector3(16500, 16500, 2048f));
            boxes[(int)MapId.CastleOfChaos] = new BoundingBox(new Vector3(17000, 17000, -2048f), new Vector3(17500, 17500, 2048f));
            boxes[(int)MapId.Inferion] = new BoundingBox(new Vector3(18000, 18000, -2048f), new Vector3(18500, 18500, 2048f));
            boxes[(int)MapId.BatleField] = new BoundingBox(new Vector3(19000, 19000, -2048f), new Vector3(19500, 19500, 2048f));
            boxes[(int)MapId.DecaronLab] = new BoundingBox(new Vector3(20000, 20000, -2048f), new Vector3(20500, 20500, 2048f));
            boxes[(int)MapId.FieldOfHonnor] = new BoundingBox(new Vector3(21000, 21000, -2048f), new Vector3(21500, 21500, 2048f));
            boxes[(int)MapId.OX] = new BoundingBox(new Vector3(22000, 22000, -2048f), new Vector3(22500, 22500, 2048f));
            boxes[(int)MapId.IceQuarry] = new BoundingBox(new Vector3(23000, 23000, -2048f), new Vector3(23500, 23500, 2048f));
            boxes[(int)MapId.BurnedoutForest] = new BoundingBox(new Vector3(24000, 24000, -2048f), new Vector3(24500, 24500, 2048f));
            boxes[(int)MapId.DesolatedMarsh] = new BoundingBox(new Vector3(25000, 25000, -2048f), new Vector3(25500, 25500, 2048f));
            boxes[(int)MapId.FrigidWastes] = new BoundingBox(new Vector3(26000, 26000, -2048f), new Vector3(26500, 26500, 2048f));
            boxes[(int)MapId.NeverFall] = new BoundingBox(new Vector3(27000, 27000, -2048f), new Vector3(27500, 27500, 2048f));
