...
namespace WCell.Constants
{
    ...
    public enum DeleteResponses : byte
    {
        Success = 1,
        LeaderOfGuildError = 2,
        MemberOfGuildError = 3,
        ItemInShoppingError = 4
    }
	/// <summary>
	...
	{
        AuthorizeRequest = 1003,
        AuthorizeResponse = 1004,
        SelectServerRequest = 1012,
        ChanelInfoResponse = 1013,
        SelectChanelRequest = 1005,
        CharacterInfos = 1007,
        CharacterNames = 1006,
        ShowCharactersView = 1025,
        Ping = 1000,
        CreateCharacterRequest = 1014,
        CreateCharacterResponse = 1026,
        EnterGameRequset = 1016,
        CharacterInfoLS = 1007,
        EnterGameRespose = 1017,
        DeleteCharacterRequest = 1018,
        DeleteCharacterRespone = 1019,
        EnterGameResponseItemsOnCharacter = 1027,
        EnterWorldIpeResponse = 1021,
        CreateCharacterResponseOne = 1015,
		MSG_NULL_ACTION = 0,
		CMSG_BOOTME = 1,
		CMSG_DBLOOKUP = 2,
		SMSG_DBLOOKUP = 3,
        ...
        PreviousSoulmateInfo = 2244,
        PreviousSoulmateInfoRes = 2243,
	    CharacterInitOnLogin = 4001,
	    CharacterInfoSessIdPosition = 4003,
	    CharacterVisibleNow = 4005,
	    StartMove = 4006,
        StartMoveCommon = 4007,
        EndMove = 4008,
        EndMoveCommon = 4009,
        CharacterDelete = 4011,
        MonstVisible = 4013,
        MonstMove = 4015,
        MonstTest = 4016,
        MonstrStateChanged = 4017,
        CharacterAddEquipment = 4021,
        CharacterRemoveEquipment = 4023,
        Emote = 4024,
        EmoteResponse = 4025,
        StartAtack = 4026,
        StartAtackResponse = 4027,
        ContinueAtack = 4028,
        MonstrTakeDmg = 4029,
        LvlUp = 4036,
        ExpGained = 4038,
        ShopInventoryInfo = 4045,
        SomeInitGS = 4046,
        
	    RegularInventoryInfo = 4048,
        SomeInitGSOne = 4049,
        SelfDeath = 4053,
        ResurectOnDeathPlace = 4054,
        ResurectWithChangeLocation = 4055,
        Resurect = 4056,
        CharHpUpdate = 4058,
        CharMpUpdate = 4059,
        UpdateStats = 4060,
        ...
        NpcVisiableNow = 4067,
        SettingsFlags = 4070,
        MonstrTakesDamageSecondary = 4102,
        GuildInfoOnLogin = 4123,
        ClanFlagAndClanNameInfoSelf = 4124,
        GuildMembersInfo = 4125,
        GuildMembersInfoEnded = 4126,
        CreateGuild = 4104,
        GuildCreated = 4105,
        DisolveGuild = 4106,
        GuildDisolved = 4107,
        SendInviteGuild = 4108,
        SendInviteGuiledResponse = 4109,
        JoinMyGuildRequest = 4110,
        LeaveGuild = 4116,
        JoinGuildResponse = 4111,
        YouHaveLeftGuild = 4117,

        KickFromGuild = 4119,
        YouHaveBeenKickedFromGuild = 4127,
        UpdateGuildInfo = 4123,
        GuildNotification = 4118, 
        GuildChatReq = 4120,
        GuildChatRes = 4121,
        SetPrivilegies = 6521,
        PrivilagiesChanged = 4114,
        ChangeClanMemberRank = 4127,
        ChangeClanMemberRankAccessResult = 4128,
        //RegisterGuildCrest = 4129,
        RegisterGuildCrest = 6524,
        RegisterGuildCrestResult = 4130,
        EditClanNotice = 6513, //4131

        AnnouncementEdited = 6512, //4132
        WritePublicGuildMemberNote = 6518,
        EditPublicGuildNote = 6519,
        ChangeGuildLeaderRequest = 4135,
        AskForGuildHistory = 4139,
        GuildHistory = 4140,
        GuildHistoryEnded = 4141, 
        ReqUpdateGuildPoints = 4142,
        UpdateGuildPoints = 4143,
        DonateGuildPoints = 4144,
        GuildPointsDonated = 4145,
        LevelUpGuild = 4146,
        GuildLeveluped = 4147,
        GuildSkillsInfo = 4148,
        LearnClanSkill = 4161,
        ClanSkillLearned = 4162,
        GuildSkillStatusChanged = 4149,
        ActivateGuildSkill = 4163,
        GuildSkillActivated = 4164,
        ImpeachmentReuest = 4167,
        ImpeachmentStatus = 4168,
        ImpeachmentAnswer = 4169,
        ImpeachmentVote = 4170,
        ImpeachmentResult = 4171,
        
        StartAtackCharacter = 4201,
        StartAtackCharacterResponse = 4202,
        AtackCharacter = 4203,
        AtackCharacterRes = 4204,
        SetAtackStateGui = 4205,

        FightingModeChanged = 4206,
        PvpRquest = 4302,
        AnswerPvpRequestOrStartPvp = 4303,
        DuelEnded = 4304,
        PvpRoundEffect = 4305,
        ReplaceItem = 5000,
        ItemReplaced = 5001,
        ItemDroped = 5005,
        RemoveItem = 5006,
        ItemRemovedFromInventory = 5007,
        PickUpItem = 5012,
        ItemPickuped = 5013,
        RemoveItemFromWorld = 5015,
        SellItem = 5018,
        SellItemResponse = 5019,
        BuyItem = 5020,
        BuyItemResponse = 5021,

        MoveSoulStoneIn = 5024,
        ItemSoweled = 5025,
        UseItem = 5028,
        CharUsedItem = 5029,
        CompleteQuest = 5041,
        ...
        AcceptQuest = 5043,
        AcceptQuestRes = 5044,
        UpdateQuestTest = 5046,
        QuestsList = 5047, // 0x000013B7
        AcceptBBQuest = 6591,
        TeleportedByCristal = 5055,
        ConquerRequest = 5056,
        ConquerResponse = 5057,
        CharacterInitOnChanelChange = 5058,
        FastItemSlotsInfo = 5059,
        SetFastItemSlot = 5067,
	    NormalChat = 5084,
        NormalChatResponse = 5085,
        AnnChat = 5086,
        AnnChatResponse = 5087,
        WishperChatRequest = 5088,
        WishperChat = 5089,
        SendPartyInvite = 5090,
        InviteToPartyResponseOrRequestToAnotherPlayer = 5091,
        PartyInvireAnswer = 5092,
        PartyIniteResponse = 5093,
        InviteSecodCharToParty = 5094,
        LeaveFromParty = 5098,
        ExileFromParty = 5100,
        PartyMemberKicked = 5101,
        PartyHasBroken = 5103,
        PartyMemberPositionInfo = 5104,

        PartyChat = 5105,
        PartyChatResponse = 5106,
        PartyInfo = 5107,
        PartyMemberBuffInfo = 5108,
        PartyMemberInitialInfo = 5109, 
        SoulmateEnterdGame = 5110,
        SoulMateHpMpUpdate = 5111,
        SoulmateBuffUpdateInfo = 5112,
        SoulmateRequest = 5200,
        SoulmateRequestResponse = 5201,
        AnswerSoulmateRequest = 5202,
        YouHaveSoulmatedWith = 5203,
        DisbandSoulMate = 5204,
        DisbandSoulMateResult = 5207,
        SoulMateInfoInit = 5220,
        SoulmatePosition = 5223,
        SoulmateLoggedOut = 5226,
        SkillsInfo = 5251,
        LearnSkill = 5253,
        SkillLearned = 5254,
        UseSkill = 5256,
        UseSkillResult = 5257,
        AnimateSkillStrike = 5270,
        SetSkillCooldown = 5271,
        CharacterBuffed = 5272,
        BuffEnded = 5273,
        SkillReady = 5274,
        TradeRequest = 5282,
        TradeRequestResponse = 5283,
        StartTradeResponse = 5284,
        TradeStarted = 5285,
        CancelTrade = 5286,
        TradeRejected = 5287,
        PushItemToTrade = 5288,
        ItemToTradePushed = 5289,
        PopItemFromTrade = 5290,
	    ConfimTradeOne=5291,
	    ConfimTradeFromOponent=5292,
	    ConfimTradeTwo = 5293,
	    ShopTradeComplete = 5294,
        RegularTradeComplete = 5295,
        PreResurect = 5306,
        StartDig = 5428,
        StartDigResponse = 5429,
        SendDigMove = 5430,
        DigEnded = 5431,
        OptionTransfer = 5433,
        OptionTransfered = 5434,
        TeleportByCristal = 5477,
        UseShopItem = 5450,
	    UpdateShopItemInfo = 5451,
        ShopItemUsed = 5453,
        CancelFunctionalItem = 5454,
        StopUseFunctionalItem = 5455,
        WarehouseSlotsExpanded = 5456,
        UseTeleportScroll = 5458,
        TeleportScrollUsed = 5459,
        GetedTitles = 6066,
        OpenBooster = 5468,
        bosterOpened = 5469,
        WhoIsHere = 5480,
        WhoIsHereList = 5481,
        WhoIsHereListEnded = 5482,
	    FindSoulMateReq = 5483,
	    SoulmatesList = 5484,
	    SoulmatesListEnded = 5485,
        ClientCanLoginToGS = 6004,
        UpdateFriendShipPoints = 6047,
        SkillLearnedFirstTime = 6056,
        AllSkillsReseted = 6057,
        YouGetNewTitle = 6065,
        MySessionId = 6066,
        SetTitle = 6067,
        CharacterPlaceInTitleRating = 6068,
        SpeedChanged = 6071,
        /// <summary>
        /// server and client packets
        /// </summary>
        CharacterSoulMateIntrodactionUpdate = 6080,
        TitleDiscovered = 6085,
        DiscoveredTitles = 6086,
        OpenPackage = 6096,
        OpenPackageResponse = 6097,

        SummonPet = 6100,
        PetSummonOrUnSummond = 6101,
        HatchEgg = 6102,

        EggHatched = 6103,
        
        UpdatePetHunger = 6104,
        UpdatePetExp = 6105,
        InitPetInfoOnLogin = 6106,
        
        PetGoesSleepDueStarvation = 6107,
        ResurectPet = 6108,
        PetResurected = 6109,
        RemovePet = 6110,
        ...
        PetRemoved = 6111,
        PetSyntes = 6112,
        PetSyntesResult = 6113,
        
        ChangePetName = 6118,
        PetNameChanged = 6119,
        CharacterInfoPet = 6120,
        DiceRequest = 6127,
        DiceResponse = 6128,
        CommisProd = 6150,
        CommisProdRes = 6151,
        CharacterFriendShip = 6152,
        BreakPetLvlLimit = 6148,
        PetLevelLimitBreaked = 6149,
        
        CharacterInfoClanName = 6153,
        BuffsOnCharacterInfo = 6154,
        SetSkiillPowersStats = 6157,
	    ByuItemFromWarshop = 6162,
        ItemFromWarshopBuyed = 6163,
        UpdateFishingLvl = 6164,
        StartFishing = 6167,
        FishingStarted = 6168,
        FishArrows = 6169,
        FishArrowsResponse = 6170,
        EndFishing = 6171,
        FishingEnded = 6172,
        SomeOneStartedFishing = 6173,
        FishingBooksInfo = 6174,
        FishingBookListEnded = 6175,
        RegisterFishingBook = 6176,

        FishingBookRegistered = 6177,
        ReciveFishingBookReward = 6182,
        FishingBookRewardRecived = 6183,



        IHaveLearnedTutorial = 6184,
        ItemsFromAvatarWhRetrived = 6221,

        WiningFactionInfo = 6257,
        StoreAvatarItems = 6258,
        AvatarItemsStored = 6259,
        RetriveItemsFromAvatarWh = 6260,
        OpenPrivateShopWindow = 6300,
        PrivateShopWindoOpened = 6301,
        OpenPrivateShop = 6302,
        PrivateShopOpened = 6303,
        TradeStatusTextWindow = 6304,
        ViewCharacterTradeShop = 6307,
        CloseCharacterTradeShop = 6305,
        CloseCharacterTradeShopResponseToOwner = 6306,
        CharacterPrivateShopInfo = 6308,
        BuyItemFromCharacterPrivateShop = 6309,
        ItemBuyedFromPrivateShop = 6310,
        ItemBuyedFromPrivateShopToOwnerNotify = 6311,
        PrivateShopChatNotificationAboutBuy = 6312,
        PrivateShopChatReq = 6313,
        PrivateShopChatNotification = 6315,
        PrivateShopChatRes = 6314,
        DisasembleEquipment = 6502,
        EquipmentDisasembled = 6503,
        UpgradeItemRequest = 6504,
        UpgradeItemResponse = 6505,
        FixGearRequest = 6506,
        FixGearResponse = 6507,
        SelectCharacter = 6538,
        SelectCharacterRespone = 6539,
        TransferUpgrade = 6551,
        UpgradeTransfered = 6552,
        ExchangeOption = 6553,
        ExchangeItemOptionResult = 6554,
        GlobalChatWithItem = 6560,
	    GlobalChatWithItemResponse = 6561,
        GlobalChat = 6561,
        UpdateDurability = 6570,
        LeanedRecipes = 6597,
        LearnRecipe = 6598,
        RecipeLeadned = 6599,
        Craft = 6602,
        Crafted = 6603,
        GlobalChatRemoveItem = 6610,
        GlobalMessage = 6615,
        LongTimeBuffsInfo = 6633,
        PremiumLongBuffInfo = 6634,
        RequestUpdateWarScreenManagerData = 6700,
        UpdateWarManagerScreenData = 6701,
        SelectFactionReq = 6702,
        SelectFactionRes = 6703, 
        YouCanEnterWarAfter = 6710,
        YouCanEnterWar = 6711,
        FactionAndHonorPointsInit = 6713,
        EnterBatlefield = 6714,
        CharacterFactionAndFactionRank = 6722, 
        WarHasBeenCanceled = 6740,
        SetClientTime = 6759,
        RegisterItemToAuk = 9901,
	    RegisterItemToAukCancelWindow = 9902,
	    ShowMyAukItems= 9907,
	    MyAukItemsInfo = 9908,
	    LoadDataFromAukPage = 9903,
	    ItemsOnAukInfo = 9904,
	    BuyFromAuk = 9905,
	    ItemsBuyedFromAuk = 9906,
	    RemoveFromAuk = 9909,
	    ItemFromAukRemoved = 9910,
	    LocationInit = 20000,
		Maximum,
        Unknown,
        ...
        ShowWarehouse = 4050,
        ShowWarehouseItems = 4051,
        ShowWarehouseEnd = 4052,
	    AvatarWhItemsList = 4211,
	    AvatarWhItemsListEnded = 4212,
	    ShowAvatarWhItems = 4210,
	    PushToWarehouse=5008,
        ItemsPushedToWarehouse = 5009,
        TakeItemFromWarehouse = 5010,
        ItemFormWarehouseTaked = 5011,

        MoveSoulStoneOut = 5022,
        SowelRemoved = 5023,
        SaveBindLocation = 5280,
        IDontKnowAboutCHaracter = 5416,
	    AllSkillsResetedInfoMsg = 5462,
	    ChangeFaceOrHair=5470,
	    FaceOrHairChanged=5471,
        DismissPlayerFromWar = 6186,
        DismissPlayerFromWarRequestResult = 6187,
        QuestionDismissPlayerOrNot = 6188,
        AnswerDismissPlayer = 6189,
        DissmissResult = 6190,
        RegisterToWar=6706,
        RegisteredToWar = 6707,
        CancleWarPatipication = 6708,
        WarPartipicationCanceled = 6709,
        WarTeamList = 6715,
        ShowWarUnit = 6717,
	    OpenMailBox = 6618,
	    MailsList = 6619,
	    SendMailMessage=6620,
	    MailMessageSended=6621,
	    ShowMailMsg = 6622,
	    MailMessageInfo = 6623,
	    TakeMailItem=6624,
	    MailItemTaked=6625,
	    DeleteMailMessage=6626,
        MailMessageDeleted = 6627,
        DisassembleAvatar = 6629,
        AvatarDissasembled = 6630,
        WarTeamListEnded = 6716,
        CharacterPositionInfoOnWar = 6720,
        UpdatePointInfo = 6725,
        WarPointsPreInit = 6726,
        TeamPoints = 6729,
	    SomeOneKilledSomeOne = 6730,
	    WarChatRequest = 6718,
	    WarChatResponse = 6719,

        WarCurrentActionInfo = 6728,
        LeaveBattleGround = 6731,
        WarEnded = 6732,
        WarEndedOne = 6733,
	    WarRemainingTime=6736,
	    HowManyPeopleInWarTeams=6742,
	    CharacterHasLeftWar=6721,


	    AdvacedEnchantWeapon=6500,
        AdvancedEnchantDone = 6501,
	    StartOcupyPoint =6723,
	    OccupyingPointStarted=6724,

	    StartAvatarSynthesis = 6631,
	    AvatarSynthesisResult=6632,
	    SoketAvatar = 6635,
	    AvatarSocketed = 6636,
	    SaveLocation=6220,
	    LocationSaved=6221,
	    DeleteSavedLocation=6222,
	    SavedLocationDeleted=6223,
	    SavedLocationsInit=6225,
	    YouHaveNewMail=6628,
	    DisplayItem=6129,
	    ItemDisplayed=6130,
	    GetCharecterInfo=5478,
	    CharacterFullInfo=5479,
	    CharacterRegularEquipmentInfo=7006,
	    CreateChatRoom=6240,
	    ChatRoomCreated=6241,
	    ChatRoomVisible=6248,
	    EnterChatRoom=6242,
	    EnterChatRoomResult=6243,
	    ChatRoomEvent=6249,
	    ChatRoomClosed=6245,
	    SendRoomChatMessage=6246,
	    RoomChatMsg=6247,
	    DissmissPlayerFromChatRoom=6250,
	    DissmisedFromCharRoomResult=6251,
	    CloseChatRoom=6244,
	    AddFriend=4150,
	    FriendAdded=4151,
	    InviteFromeSomeoneFriend=4152,
	    InviteFriendAnswer=4153,
	    DeleteFromFriendList=4154,
	    DeletedFromFriendList=4155,
	    FriendList=4157,
	    ShowFriendList=4156,
	    FriendListEnded=4158,
	    AppleExpGained=6049,
	    EatApple=6575,
	    AppleRandom=6576,
	    SendSoulmateMessage=6052,
	    SoulmatemessageSended=6053,
	    IncomingSoulmateMessage=6055,
	    GetApplePrize=6579,
	    AppleEatResult=6580,
	    UseSoulmateSkill=5231,
	    SoulmateSkillCast=5233,
	    SoulmateSkillUsed=5234,
	    SoulmateSummoningYou=5236,
	    TeleportToSoulmateAnswer=5427,
	    MonstrUsedSkill = 8012,
	    UseSoulGuardSkill=6158,
	    CombineItem=6098,
	    ItemCombined=2270,
	    SummonBoss=6124,
	    MonsterSummoned=6125,
	    SomeNewItemRecived=6226,
	    ShowMeItemMallItems=11004,
	    ItemMailList=11005,
	    ItemFromMailTaked=11007,
	    RefreshPoints = 5466,
	    PointsRefreshed = 5467,
	    TakeItemFromMail=11006,
	    UseChangeFactionItem=6704,
	    FactionReseted=6705,
	    WingsInfo =6585,
	    NpcBuffed=6079,
	    ExpandPetBox = 6121,
	    ...
	    SkillReseted = 5464,
	    RepairItem=6571,
	    RepairItemResponse=6572,
	    TransformToPet =6637,
	    RegisterVeiche = 6768,
	    VeicheRegistered=6769,
	    SummonMount =6763,
	    CHaracterOnMountStatusChanged=6764,
	    VeicheStatusChanged=6767,
	    MountSummoning=6765,
	    GetOnMount=6766,
	    MountBoxSizeInit=6761,
	    OwnedMountsList=6762,
        U8226 = 8226,
        U8227 = 8227,
        U8215 = 8215,

		YouGotQuest = 5044,
		GetRaidQuestRespond = 6590,
	    Disconnect = 4101,
	    CancelSkill = 6142,
	    MessageServerAboutWarStarts = 3113
	}
